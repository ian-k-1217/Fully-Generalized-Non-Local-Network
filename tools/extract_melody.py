...
if __name__ == '__main__':
	art_dirs = ['../dataset/artist20', '../dataset/temp/artist20_open_unmix_vocal']
	save_dirs = ['../dataset/melody_artist20_origin', '../dataset/melody_artist20_vocal']
    
	for i in range(len(art_dirs)):
		art_dir = art_dirs[i]
