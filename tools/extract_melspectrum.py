...
if __name__ == '__main__':    
    # origin
    art_dir = '../dataset/artist20'
    save_dir = '../dataset/melspectrum_artist20_origin'
    print('art_dir:', art_dir)
    print('save_dir:', save_dir)
    create_dataset_parellel(artist_folder=art_dir, save_folder=save_dir, num_worker=16)

    # vocal
    # folder structure should follow artist20's
    art_dir = '../dataset/temp/artist20_open_unmix_vocal'
    save_dir = '../dataset/melspectrum_artist20_vocal'
    print('art_dir:', art_dir)
    print('save_dir:', save_dir)
    create_dataset_parellel(artist_folder=art_dir, save_folder=save_dir, num_worker=16)